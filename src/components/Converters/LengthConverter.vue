...
export default {
  ...
  data() {
    return {
      inputSelect: [{name: 'Meters (m)', slug: 'meter', unit: 'm'}, {name: 'Inches (in)', slug: 'inch', unit: 'in'}, {name: 'foot (ft)', slug: 'foot', unit: 'ft'}, {name: 'yard (yd)', slug: 'yard', unit: 'yd'},
        {name: 'mile  (mi)', slug: 'mile', unit: 'mi'}],
      outputSelect: [{name: 'Meters (m)', slug: 'meter', unit: 'm'}, {name: 'Inches (in)', slug: 'inch', unit: 'in'}, {name: 'foot (ft)', slug: 'foot', unit: 'ft'}, {name: 'yard (yd)', slug: 'yard', unit: 'yd'},
        {name: 'mile  (mi)', slug: 'mile', unit: 'mi'}],
      currentInputSelect: {name: 'Inches (in)', slug: 'inch', unit: 'in'},
      currentOutputSelect: {name: 'Centimeters', slug: 'cm', unit: 'cm'},
      calculation: '',
      output: '',
      active: 'input'
    }
